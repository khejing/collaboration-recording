        ...
        portFinder.getPort(function (err, port) {
            ...
            function ffmpegOutput(command){
                command
                    .audioCodec("aac")
                    .videoCodec("libx264")
                    .outputOptions(["-pix_fmt yuv420p", "-tune zerolatency", "-crf 28", "-hls_time 10", "-hls_list_size 0","-threads 0", "-shortest"]);
            }
            ...
            ffmpegCommand
                ...
                .input(displayOpt)
                .inputFormat("x11grab")
                .inputOptions(["-framerate 25", "-video_size 1366x768", "-draw_mouse 0"])
